...
export default function SettingsPageClient() {
  ...
  const [activeTab, setActiveTab] = React.useState<
    "profile" | "billing" | "security" | "danger"
  >("profile");
  ...
  React.useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      ...
      if (queryParams.get("upgraded") === "true") {
        success(
          "Congratulations! You have successfully upgraded to SmartSpend Pro! 🎉",
        );
  ...
  // Handle Stripe checkout redirection (Replaced with Demo)
    ...
    <div className="space-y-8 text-left select-none relative w-full pb-10">
      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between border-b border-white/[0.06] pb-6">
        <div>
          ...
          <p className="text-sm text-[#94A3B8] mt-1">
            Manage profile info, active subscription plans, defaults, and
            security configurations.
          </p>
        </div>
        {isProUser && (
          <span className="self-start sm:self-auto inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-gradient-to-r from-cyan-500/10 via-cyan-600/10 to-blue-500/10 border border-cyan-500/20 text-white shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <Card className="bg-[#09090B] border border-white/[0.04] rounded-2xl p-6 text-center shadow-sm relative">
            ...
            <div className="flex flex-col items-center">
              ...
              <motion.div
                ...
                className="p-1 rounded-full border border-white/[0.08] mb-4 group inline-block"
              >
                <div className="w-20 h-20 rounded-full bg-[#0A0E1A] flex items-center justify-center text-[#F1F5F9] font-extrabold text-2xl relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tr from-cyan-500/20 via-cyan-600/20 to-blue-500/20 transition-opacity duration-300" />
                </div>
              </motion.div>
              ...
              <div className="space-y-1.5 w-full flex flex-col items-center">
                ...
                <p className="text-xs text-[#94A3B8] font-mono select-all selection:bg-cyan-500/20 max-w-[180px] truncate block text-center">
                  {profileEmail}
                </p>
              </div>
              ...
              <div className="mt-4.5">
                {isProUser ? (
                  <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-cyan-500 via-cyan-600 to-blue-500 text-white shadow-sm border border-white/[0.08]">
          ...
          <div className="hidden lg:flex flex-col gap-1.5 p-2 bg-transparent border border-white/[0.04] rounded-2xl ">
            {tabs.map((tab) => {
              const Icon = tab.icon;
                ...
                >
                  {isActive && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 via-cyan-600/10 to-blue-500/10 rounded-xl border border-cyan-500/20 shadow-sm"
                      transition={{
                        type: "spring",
                        stiffness: 380,
                        damping: 30,
          ...
          <div className="flex lg:hidden overflow-x-auto scroll-smooth touch-pan-x snap-x gap-2 p-1.5 bg-transparent border border-white/[0.04] rounded-2xl [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden ">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              const isActive = activeTab === tab.id;
              return (
          ...
          <AnimatePresence mode="wait">
                ...
                <Card className="bg-[#09090B] border border-white/[0.04] text-left shadow-sm rounded-2xl overflow-hidden">
                  <CardHeader className="pb-4 border-b border-white/[0.04]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <CardTitle className="text-md font-bold text-white/90">
                          Profile Details
                        </CardTitle>
                        <CardDescription className="text-xs text-[#94A3B8] mt-0.5 font-medium">
                          Configure primary display parameters and
                          communications.
                        </CardDescription>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleProfileSubmit} className="space-y-5">
                      ...
                      <div className="flex justify-end pt-4 border-t border-white/[0.04]">
                        <Button
                          ...
                          className="px-5 h-10 font-bold bg-[#F1F5F9] text-[#0A0E1A] hover:bg-white flex items-center gap-1.5 shadow-sm rounded-xl"
                        >
                  ...
                  <CardHeader className="pb-4 border-b border-white/[0.04]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-xs text-[#94A3B8] mt-0.5 font-medium">
                          Customize localizations, date visual grids, and
                          default categories.
                        </CardDescription>
                      </div>
                    </div>
                    ...
                    <CardHeader className="pb-4 border-b border-white/[0.06] relative">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                          <div className="p-2 rounded-xl bg-gradient-to-tr from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 text-white shadow-sm">
                          ...
                          <div>
                            ...
                            <CardDescription className="text-xs text-white/80 font-bold mt-0.5">
                              Active Premium Subscription
                            </CardDescription>
                          </div>
                        </div>
                        <span className="self-start sm:self-auto inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-cyan-500 via-cyan-600 to-blue-500 text-white shadow-sm border border-white/[0.08]">
                          <Crown className="w-3.5 h-3.5 fill-current" /> Pro
                          Member
                        </span>
                      </div>
                    </CardHeader>
                    <CardContent className="p-6 space-y-6">
                      <div className="bg-white/[0.02] border border-white/[0.06] p-5 rounded-2xl space-y-3 relative overflow-hidden">
                        ...
                        <p className="text-xs text-[#94A3B8] leading-relaxed">
                          Your account currently utilizes all SmartSpend premium
                          analysis features. Management of billing and plans is
                          processed securely in your Stripe customer dashboard.
                          You have full access to predictive analysis warnings,
                          premium Heatmaps, customized monthly presets, and
                          remove all category limits.
                        </p>
                      </div>
                      <div className="flex justify-end">
                        <Button
                          ...
                          className="w-full sm:w-auto flex items-center justify-center gap-2 text-xs font-bold h-11 bg-white/[0.04] hover:bg-white/[0.08] text-white border border-white/[0.06] hover:border-cyan-400/20 hover:shadow-sm transition-all duration-300 px-6 rounded-xl"
                        >
                          <Shield className="w-4 h-4 text-white" /> Manage
                          Subscription
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-[#09090B] border border-white/[0.04] text-left shadow-sm rounded-2xl overflow-hidden">
                      ...
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <CardDescription className="text-xs text-[#94A3B8] mt-0.5">
                            Upgrade to unlock Heatmaps, Multi-Category
                    ...
                    <CardContent className="pt-6 space-y-6">
                      <div className="bg-gradient-to-tr from-[#6366F1]/5 via-transparent to-transparent border border-[#6366F1]/10 p-5 rounded-2xl space-y-4">
                        ...
                        <p className="text-xs text-[#94A3B8] leading-relaxed">
                          Get predictive analysis warnings, premium Heatmaps,
                          customized monthly presets, and remove limits for only{" "}
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2 border-t border-white/[0.04]">
                        ...
                        <Button
                          ...
                          isLoading={stripeLoading}
                          className="w-full sm:w-auto flex items-center justify-center gap-2 text-xs font-bold h-11 bg-gradient-to-r from-cyan-500 via-cyan-600 to-blue-500 hover:opacity-90 text-white shadow-sm hover:shadow-sm transition-all duration-300 font-extrabold rounded-xl border border-white/[0.08] px-6"
                        >
                          <Sparkles className="w-4 h-4 text-warning" /> Upgrade
                          to Pro
                        </Button>
                      </div>
                    </CardContent>
                  ...
                  <CardHeader className="pb-4 border-b border-white/[0.04]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-xs text-[#94A3B8] mt-0.5 font-medium">
                          Keep credentials secure with periodic updates.
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
            ...
            {activeTab === "danger" && (
              <motion.div
                ...
                className="space-y-6"
              >
                <Card className="bg-[#111827]/60 backdrop-blur-xl border border-red-500/30 shadow-sm rounded-2xl overflow-hidden relative">
                  ...
                  <CardHeader className="pb-4 border-b border-red-500/[0.08]">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-xs text-red-300 mt-0.5 font-medium">
                          High-risk actions containing irreversible operations.
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="p-6 space-y-6">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-red-500/10 border border-red-500/30 p-5 rounded-2xl shadow-sm">
                      <div className="space-y-1.5 max-w-lg">
                        <h4 className="text-sm font-bold text-red-200">
                          Permanently Delete Account
                        </h4>
                        <p className="text-xs text-[#94A3B8] leading-relaxed">
                          Erase transaction tables, budget alert records,
                          historical categories database, and deactivate
                          subscriptions instantly. This is irreversible.
                        </p>
                      </div>
                      <Button
                        variant="danger"
      ...
      >
        <div className="space-y-5 text-left">
          <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-xl flex gap-3 text-red-300 items-start shadow-sm">
            <AlertTriangle className="w-5 h-5 shrink-0 mt-0.5 text-red-400" />
            <div className="text-xs leading-relaxed space-y-1">
              <span className="font-bold text-red-200">Important Notice:</span>
              <p className="text-red-300/90">
                After execution, your database documents will be scheduled for
                soft deletion and archived, removing all dashboard panels. You
          ...
          <div className="space-y-2">
            <label className="text-xs font-bold text-[#94A3B8] block">
              Type{" "}
              <span className="font-mono bg-red-500/20 text-red-300 px-1.5 py-0.5 rounded font-black">
                DELETE
              </span>{" "}
              to confirm:
            </label>
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-white/[0.06]">
            ...
            <Button
              ...
              className="px-6 font-bold bg-red-500 hover:bg-red-600 text-white hover:shadow-sm"
            >
              Confirm Deletion
            </Button>
          </div>
